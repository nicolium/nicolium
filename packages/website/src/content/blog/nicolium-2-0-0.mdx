...
<marquee>look there's a nicolium button!!!</marquee>

<img src="/nicolium_sliding_88x31.gif" width="88" height="31" alt="My profile is best viewed with Nicolium (Free!)" style="border-radius:0;height:31px;width:100%;object-fit:contain" />
...
This doesn’t mean I will ignore suggestions received in the Issues section. I’m just likely done with my own ideas for new features and I’m not so excited about working on *bigger* features anymore. Because the versioning became somewhat resembling [*pride versioning*](https://mastodon.online/@nikitonsky/113691789641950263), I will probably switch the project to CalVer to not keep it under v2.x.x forever. Also, it will be funny to bump the version by 24 major versions at once without bringing any significant changes lol
