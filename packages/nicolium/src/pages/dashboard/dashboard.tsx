...
const DashboardPage: React.FC<IDashboardPage> = ({ aside = false }) => {
  const intl = useIntl();
          ...
          <DashCounters>
            ...
            {features.mastodonAdminMetrics ? (
              <Counter
                ...
                label={
                  <FormattedMessage
                    id='admin.counters.active_users'
        ...
        <List>
          ...
          {features.pleromaAdminRelays && (
            <ListItem
              ...
              label={<FormattedMessage id='column.admin.relays' defaultMessage='Relays' />}
            />
          )}
