...
const DomainBlock: React.FC<IDomainBlock> = ({ domainBlock }) => {
  ...
  return (
    <div className='admin-domain-block'>
      <div className='admin-domain-block__domain'>{domainBlock.domain}</div>
      <ul className='admin-domain-block__tags'>
      ...
      {domainBlock.private_comment && (
        <div className='admin-domain-block__comment'>
          <span>
            <FormattedMessage
      ...
      <div className='admin-domain-block__actions'>
  ...
  return (
    <Column bodyClassName='admin-domain-blocks' label={intl.formatMessage(messages.heading)}>
      ...
      <ScrollableList
        ...
        itemClassName='admin-domain-block__container'
      >
