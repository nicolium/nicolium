...
const instanceLayouts = {
  admin: createRoute({
    ...
    beforeLoad: requireInstanceMiddleware(),
  }),
  ...
  chats: createRoute({
    ...
    beforeLoad: requireInstanceMiddleware(
      requireAuthMiddleware(({ context: { features } }) => {
  ...
  group: createRoute({
    ...
    beforeLoad: requireInstanceMiddleware(requireAuth),
  }),
  groups: createRoute({
    getParentRoute: () => rootRoute,
    id: 'groups-layout',
...
export const homeRoute = createRoute({
  getParentRoute: () => standaloneLayouts.home,
  path: '/',
...
export const logoutRoute = createRoute({
  getParentRoute: () => instanceLayouts.empty,
  path: '/logout',
  component: lazy(() => import('@/pages/auth/logout')),
});

export const loginRoute = createRoute({
  getParentRoute: () => standaloneLayouts.default,
  path: '/login',
...
export const loginExternalRoute = createRoute({
  getParentRoute: () => standaloneLayouts.externalLogin,
  path: '/login/external',
...
export const homeTimelineRoute = createRoute({
  getParentRoute: () => instanceLayouts.home,
  path: '/timeline/home',
...
export const remoteTimelineRoute = createRoute({
  getParentRoute: () => instanceLayouts.remoteInstance,
  path: '/',
...
export const notificationsRoute = createRoute({
  getParentRoute: () => instanceLayouts.notifications,
  path: '/notifications',
...
export const eventsRoute = createRoute({
  getParentRoute: () => instanceLayouts.events,
  path: '/events',
...
export const chatsRoute = createRoute({
  getParentRoute: () => instanceLayouts.chats,
  path: '/chats',
...
export const blocksRoute = createRoute({
  getParentRoute: () => instanceLayouts.settings,
  path: '/blocks',
...
export const profileRoute = createRoute({
  getParentRoute: () => instanceLayouts.profile,
  path: '/',
...
export const statusRoute = createRoute({
  getParentRoute: () => instanceLayouts.status,
...
export const eventInformationRoute = createRoute({
  getParentRoute: () => instanceLayouts.event,
  path: '/',
...
export const groupsRoute = createRoute({
  getParentRoute: () => instanceLayouts.groups,
  path: '/groups',
...
export const groupTimelineRoute = createRoute({
  getParentRoute: () => instanceLayouts.group,
  path: '/',
...
export const manageGroupRoute = createRoute({
  getParentRoute: () => instanceLayouts.manageGroups,
...
export const newStatusRoute = createRoute({
  getParentRoute: () => instanceLayouts.fullWidth,
  path: '/statuses/new',
...
export const adminDashboardRoute = createRoute({
  getParentRoute: () => instanceLayouts.adminHome,
  path: '/nicolium/admin',
...
export const adminAccountsRoute = createRoute({
  getParentRoute: () => instanceLayouts.admin,
...
const routeTree = rootRoute.addChildren([
  instanceLayouts.adminHome.addChildren([adminDashboardRoute]),
  instanceLayouts.admin.addChildren([
    adminAccountsRoute,
    adminAccountRoute,
  ...
  instanceLayouts.chats.addChildren([
  ...
  instanceLayouts.default.addChildren([
    conversationsRoute,
  ...
  instanceLayouts.empty.addChildren([
    logoutRoute,
    signupRoute,
    serverInfoRoute,
    errorRoute,
  ...
  instanceLayouts.event.addChildren([eventInformationRoute, eventDiscussionRoute]),
  instanceLayouts.events.addChildren([eventsRoute, newEventRoute, eventEditRoute]),
  instanceLayouts.fullWidth.addChildren([newStatusRoute, deckRoute]),
  instanceLayouts.group.addChildren([groupTimelineRoute, groupMembersRoute, groupGalleryRoute]),
  instanceLayouts.groups.addChildren([groupsRoute]),
  instanceLayouts.home.addChildren([
    homeTimelineRoute,
    localTimelineRoute,
  ...
  instanceLayouts.manageGroups.addChildren([
    manageGroupRoute,
    editGroupRoute,
    groupBlocksRoute,
    groupMembershipRequestsRoute,
  ]),
  instanceLayouts.notifications.addChildren([notificationsRoute]),
  instanceLayouts.profile.addChildren([
    profileRoute,
  ...
  instanceLayouts.remoteInstance.addChildren([remoteTimelineRoute]),
  instanceLayouts.search.addChildren([searchRoute]),
  instanceLayouts.settings.addChildren([
  ...
  instanceLayouts.status.addChildren([statusRoute, statusQuotesRoute]),
  standaloneLayouts.externalLogin.addChildren([loginExternalRoute]),
  standaloneLayouts.default.addChildren([loginRoute, loginAddRoute]),
  standaloneLayouts.home.addChildren([homeRoute]),
  ...redirectRoutes,
]);
...
export { instanceLayouts as layouts, rootRoute, router, RouterWithContext };
